...
const MiniPlayer = () => {
    ...
    if (playerContext.isEmpty || !playerContext.currentTrack) { return null }
    return (
        <Box h={75} bg="white" px="md" style={{ borderTopWidth: 1, borderTopColor: theme.color.greenLightest }}>
            <Box f={1} dir="row" align="center" justify="between">
                <Box h={50} w={50} bg="greenLight" mr={10} radius={10} style={{ overflow: "hidden" }}>
                ...
                <Box mr={10}>
                    {playerContext.isPaused && (
                        <TouchableOpacity onPress={() => playerContext.play(playerContext.currentTrack!)}>
