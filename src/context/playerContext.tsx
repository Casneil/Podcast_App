...
import TrackPlayer, { Track, State as TrackPlayerState, STATE_PLAYING, STATE_PAUSED, STATE_STOPPED } from "react-native-track-player";
...
export const PlayerContextProvider: React.FC = (props) => {
    ...
    React.useEffect(() => {
        const listener = RNTrackPlayer.addEventListener("playback-state",
